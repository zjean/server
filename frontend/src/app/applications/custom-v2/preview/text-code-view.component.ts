...
@Component({
  ...
  styles: [
    `
      ...
      /* A keystroke is machine vocabulary, so mono. A reminder rather than a control,
         but not decoration — same string and same reasoning as .md-view__hint: it is
         the only statement that a save mints a version. Quiet measured 2.43 on the
         toolbar's bg2; tertiary measures 4.84. */
      .text-view__hint {
