...
export class NcOcsController {
  ...
  // The /ocs/v2.php/apps/files/api/v1/directEditing endpoint used to be an
  // empty-editors stub here — moved to NcDirectEditingController which now
  // serves a real editor catalog so iOS lights up the Edit button. Two
  // handlers for the same route caused Fastify FST_ERR_DUPLICATED_ROUTE at
  // boot, taking down the whole server (and pull-to-refresh with it).
