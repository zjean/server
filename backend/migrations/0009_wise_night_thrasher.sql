...
ALTER TABLE `users` ADD CONSTRAINT `external_id_idx` UNIQUE(`externalId`);--> statement-breakpoint
...
CREATE INDEX `user_created_idx` ON `files_favorites` (`userId`,`createdAt`);